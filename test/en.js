export default {
  ...
  info: {
    couponReceived: {
      title: "Dear customer,",
      message:
        "Vouchers and coupons can only be validated at the cash register.",
    },
    ...
    customerCardScanned: {
      ...
      message:
        "You will automatically be credited the DeutschlandCard points for this purchase",
    },
  ...
  error: {
    ...
    unknownProduct: {
      title: "Unknown item: {$}",
      message:
        "Please call for an employee or have this item scanned at the checkout.",
    },
  ...
  sos: {
    ...
    productNotFound: {
      ...
      answer:
        "An employee will be with you to assist with your search in a moment. ",
    ...
    scannerProblems: {
      ...
      answer:
        "Staff has been notified. You may also enter the barcode number into the item search. ",
    ...
    cancel: "Cancel Help",
    map:
      "Please help our staff to find you more easily. Where are you located?",

    instructions: {
      priceDifference: {
        label: "Price difference",
        question:
          "The price of the scanned product does not match the price tag on the shelf?",
        steps: 2,
        stepsText:
  ...
  details: {
    ...
    navigation: "Navigate",
    addedForRecipe:
      'You have added this product to the list for the recipe "{sourceRecipeName}".',
    delete: "Remove",
  },
  ...
  amountConfig: {
    ...
    keepDeposit:
      "Please keep the bottle return receipt and submit it at the checkout.",
  },
  ...
  payment: {
    ...
    summary: {
      ...
      pending: "Pending",
      outside:
        "You are outside of the checkout area. Please move closer to the checkout in order to start the payment process.",
    },
    verification: {
      title: "To do",
      ...
      checkAgeRestrictionMagazine:
        "Age-restricted content: Please check magazine(s)!",
      collectLoyaltyCard: "Collect loyalty points",
      printPinForPhoneCardOrVoucher:
        "Collect printed pin for phone card/gift voucher",
    },
    inProgress: {
      title: "Payment",
    ...
    invalidPaymentMethod: {
      ...
      message:
        "An error has occured. Please try again or choose a different payment option.",
    },
    invalidPaymentMethodRequiresPos: {
      title: "Invalid Payment Method",
      message:
        "There are items in your cart that do not allow for this payment method. Please pay at the EASY Shopper checkout.",
    },
    unresolvedItems:
  ...
  voucherPromotion: {
    ...
    disclaimer:
      "The actual voucher calculation will be processed at the cashier. Deviations are possible. ",
    thursdayPromo:
      "From a purchase of {threshold} you will receive a {value} voucher. ",
  },

  discountPromotion: {
    title: "Stick your discount",
    message1:
      "Click on one of the available discounts if you want to apply it to this product.",
  ...
  customerMessage: {
    ...
    ITEMS_NEEDS_TO_BE_COLLECTED:
      "Remember to pick up the item after payment at the information desk. ",
    ...
    GIFTBASKET_SHOW_INFO_POINT:
      "Please have an employee scan this item at the EASY Shopper register.",
  ...
  settings: {
    ...
    lock: {
      ...
      explanation:
        "Allows to lock the screen and thus prevent children from adding items",
    },
  },
